...
def main() -> None:
    parser = argparse.ArgumentParser(description="Local subtitle dubbing demonstration")
    parser.add_argument("--host", default="127.0.0.1")
    parser.add_argument("--port", default=7432, type=int)
    parser.add_argument(
        "--allow-remote",
        action="store_true",
        help="acknowledge exposing this unauthenticated demonstration remotely",
    )
